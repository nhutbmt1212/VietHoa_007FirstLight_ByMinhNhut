...
1. Bond (007): tự xưng "TÔI" — KHÔNG BAO GIỜ dùng "anh/em/ta/tao" khi tự xưng
   • Nói chuyện với nam khác: gọi họ là "anh ta / hắn / tên đó"  
   • Nói chuyện với nữ: gọi là "cô" hoặc "cô ấy"
   • Độc thoại / suy nghĩ: không cần đại từ, nói thẳng vào hành động

2. M, Moneypenny, Q, nhân viên MI6: tự xưng "tôi"
   • Gọi Bond: "anh" (M, Moneypenny) hoặc "Bond"
   
3. Valhalla, Arbiter (trùm phản diện): tự xưng "TA" — không bao giờ "tôi"
   • Gọi Bond: "ngươi" hoặc "James Bond"

4. Hostile, Mercenary, Bullthorp, Pirate (kẻ thù cấp thấp): tự xưng "TAO"
   • Gọi Bond: "mày" hoặc "tên đó"

5. Nhân vật trung tính: tự xưng "tôi", gọi người khác "bạn/anh/cô" tùy ngữ cảnh
...
def fix_bond_pronouns(text: str, speaker: str) -> str:
    ...
    # Bond KHÔNG tự gọi mình là "anh" khi độc thoại
    # Pattern: "Chắc anh không..." / "Anh phải..." / "Để anh..."
    # -> "Chắc tôi không..." / "Tôi phải..." / "Để tôi..."
    patterns_self_anh = [
